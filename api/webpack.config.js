...
let ENVIRONMENT_VARIABLES = {
  ...
  'process.env.PG_CONNECTION_STR': JSON.stringify("postgres://postgres:''@localhost:5432/postgres")
};
...
if (environment === 'test') {
  ...
  ENVIRONMENT_VARIABLES = {
    ...
    'process.env.DIALECT': JSON.stringify('postgres'),
    'process.env.PORT': JSON.stringify('3080'),
    'process.env.PG_CONNECTION_STR': JSON.stringify("postgres://postgres:localhost:5432/tasks")
